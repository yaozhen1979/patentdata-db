...
(
   ...
   designation_of_states_json  jsonb,
   create_date                 date           NOT NULL,
   last_upd_date               date           NOT NULL
);
...
(
   raw_id         varchar(50)    NOT NULL,
   rel_raw_type   varchar(50)    NOT NULL,
   pat_id         varchar(50)    NOT NULL,
   raw_json       jsonb          NOT NULL,
   create_date    date           NOT NULL,
   last_upd_date  date           NOT NULL
...
ALTER TABLE pat_raw_docdb
  ADD CONSTRAINT pat_raw_docdb_pat_id_fkey FOREIGN KEY (pat_id)
  REFERENCES pat_data (pat_id)
  ON UPDATE NO ACTION
  ON DELETE NO ACTION;

ALTER TABLE pat_raw_ep
  ADD CONSTRAINT pat_raw_ep_pat_id_fkey FOREIGN KEY (pat_id)
  REFERENCES pat_data (pat_id)
  ON UPDATE NO ACTION
  ON DELETE NO ACTION;
...
ALTER TABLE pat_raw_jp
  ADD CONSTRAINT pat_raw_jp_pat_id_fkey FOREIGN KEY (pat_id)
  REFERENCES pat_data (pat_id)
  ON UPDATE NO ACTION
  ON DELETE NO ACTION;
...
ALTER TABLE pat_raw_us
  ADD CONSTRAINT pat_raw_us_pat_id_fkey FOREIGN KEY (pat_id)
  REFERENCES pat_data (pat_id)
  ON UPDATE NO ACTION
  ON DELETE NO ACTION;

ALTER TABLE pat_raw_wo
  ADD CONSTRAINT pat_raw_wo_pat_id_fkey FOREIGN KEY (pat_id)
  REFERENCES pat_data (pat_id)
  ON UPDATE NO ACTION
  ON DELETE NO ACTION;
